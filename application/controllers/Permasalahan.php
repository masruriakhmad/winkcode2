...
class Permasalahan extends CI_Controller
{
    ...
    
    {
        ...
        $this->m = new Permasalahan_model();
    }

    public function index()
    {
        $data = array(
            'content' => "backend/permasalahan/permasalahan_frm",
        );
    ...
    public function lookup()
    {
        ...
        $total = $this->db->from($this->m->table)
            ->like('permasalahan', $q)
            ->count_all_results();
        $current = $this->db->select('id, permasalahan, type')
            ->from($this->m->table)
            ->like('permasalahan', $q)
    ...
    public function prin()
    {
        ...
        $data = array(
            'h'       => $data->row(),
            'content' => 'backend/permasalahan/permasalahan_print',
        );
